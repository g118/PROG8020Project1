...
$wp_customize->add_control(
	new WP_Customize_Image_Control( $wp_customize, 'theme_options[footer_background_image]',
		...
		'description'	  => sprintf( __( 'Recommended Size %dpx X %dpx', 'restaurantz' ), 1400, 335 ),
...
$wp_customize->add_control( 'theme_options[breadcrumb_type]',
	...
	'description' => sprintf( __( 'Advanced: Requires %sBreadcrumb NavXT%s plugin', 'restaurantz' ), '<a href="https://wordpress.org/plugins/breadcrumb-navxt/" target="_blank">','</a>' ),
...
$wp_customize->add_section( 'section_advanced',
	array(
	'title'      => __( 'Advanced Options', 'restaurantz' ),
	'priority'   => 100,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'theme_options[custom_css]',
	array(
	'label'    => __( 'Custom CSS', 'restaurantz' ),
